  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (formData.type === "savings") {
        ...
        await contributeToSaving(formData.savingId, amount, userName);
        setShowPet(true);
                      ...
                      return (
                        ...
                        >
                          <Button
                            type="button"
                            variant={
                              formData.savingId === goal.id
                                ? "default"
                                : "outline"
                            }
                            onClick={() =>
                              setFormData({ ...formData, savingId: goal.id })
                            }
                            className="w-full text-left"
                          >
                            {goal.title} - ${totalContributed.toFixed(2)} / $
